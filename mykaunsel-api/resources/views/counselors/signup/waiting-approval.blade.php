        ...
        <div class="relative z-10 flex flex-1 flex-col items-center justify-center px-5 pb-10">
            <div class="w-full max-w-[480px] rounded-2xl bg-cream p-8 text-center" style="box-shadow:0 30px 70px -22px rgba(14,42,51,.3)">
                ...
                @if ($status->value === 'pending')
                    <div id="d4Pending" class="wa-lapis w-full">
                        ...
                        <h1 class="mt-6 text-[28px] font-semibold leading-[1.15] tracking-tightest md:text-[32px]">{{ __('Your application is under review') }}</h1>
                        <p class="mx-auto mt-3 max-w-[38ch] text-[14.5px] leading-relaxed text-navy/60">{{ __("We're reviewing your registration as a counselor. This usually takes 1-2 business days.") }}</p>
                        ...
                        <ul class="mt-7 flex flex-col gap-3 rounded-[14px] p-5 text-left" style="background:rgba(14,42,51,.04)">
                            ...
                            <li class="wa-item flex items-center gap-3 text-[13.5px] text-navy/75" style="--tunda:0.1s">
                                ...
                                @else
                                    ...
                                    {{ __('Documents pending') }} —
                                    <a href="{{ route('counselors.signup.documents') }}" class="font-medium text-teal">{{ __('finish upload') }}</a>
                                @endif
                            </li>
                ...
                @elseif ($status->value === 'approved')
                    <div id="d4Approved" class="wa-lapis w-full">
                        ...
                        <p class="mx-auto mt-3 max-w-[38ch] text-[14.5px] leading-relaxed text-navy/60">{{ __('Welcome to MyKaunsel. Your profile is now live and ready to accept bookings.') }}</p>
                ...
                @else
                    <div id="d4Rejected" class="wa-lapis w-full">
                        ...
                        <p class="mx-auto mt-3 max-w-[38ch] text-[14.5px] leading-relaxed text-navy/60">{{ __("We couldn't approve your application at this time.") }}</p>
                        ...
                        <div class="mt-6 rounded-xl p-4 text-left" style="background:rgba(196,87,74,.06);border-left:3px solid #C4574A">
                            ...
                            <p class="mt-2 text-[13.5px] leading-relaxed text-navy">{{ $profile->rejection_reason ?: __('No specific reason was provided. Please contact support for more details.') }}</p>
                        </div>
                        ...
                        <div class="mt-6 flex gap-3">
                            ...
                            <a href="{{ route('counselors.signup.documents') }}" class="btn-utama grid h-[44px] flex-1 place-items-center rounded-full text-[13.5px] font-medium text-white transition-all duration-200 hover:-translate-y-0.5" style="background:#4A7DFF">{{ __('Re-upload documents') }}</a>
                        </div>
